...
_Generated by `scripts/update_bench.sh` on 2026-05-18T11:32:36Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.54 | 1.54 | 30.2x | 12.92 | 4.51 | 2.86x |
| bench_fib | 135.77 | 5.40 | 25.1x | 12.83 | 4.62 | 2.78x |
| bench_loop | 105.44 | 1.78 | 59.2x | 12.86 | 4.64 | 2.77x |
