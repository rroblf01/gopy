...
_Generated by `scripts/update_bench.sh` on 2026-05-21T11:18:30Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.01 | 1.46 | 31.5x | 12.95 | 4.99 | 2.60x |
| bench_fib | 132.80 | 5.30 | 25.1x | 12.78 | 4.75 | 2.69x |
| bench_loop | 105.91 | 1.67 | 63.4x | 12.89 | 4.85 | 2.66x |
