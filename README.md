...
_Generated by `scripts/update_bench.sh` on 2026-05-19T13:10:07Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.36 | 1.67 | 28.4x | 12.72 | 4.55 | 2.80x |
| bench_fib | 133.39 | 5.84 | 22.8x | 12.67 | 4.46 | 2.84x |
| bench_loop | 114.54 | 2.66 | 43.1x | 12.72 | 4.56 | 2.79x |
