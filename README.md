...
_Generated by `scripts/update_bench.sh` on 2026-05-22T09:54:01Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.54 | 1.76 | 27.0x | 12.97 | 5.72 | 2.27x |
| bench_fib | 138.82 | 7.32 | 19.0x | 12.86 | 5.60 | 2.30x |
| bench_loop | 114.94 | 2.81 | 40.9x | 12.80 | 5.65 | 2.27x |
