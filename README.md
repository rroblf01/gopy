...
_Generated by `scripts/update_bench.sh` on 2026-05-21T09:58:51Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.88 | 1.91 | 25.1x | 12.81 | 4.86 | 2.64x |
| bench_fib | 135.48 | 5.57 | 24.3x | 12.84 | 4.91 | 2.62x |
| bench_loop | 109.95 | 1.87 | 58.8x | 12.82 | 4.69 | 2.73x |
