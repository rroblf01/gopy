...
_Generated by `scripts/update_bench.sh` on 2026-05-22T10:39:07Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.81 | 1.56 | 30.0x | 12.86 | 5.93 | 2.17x |
| bench_fib | 134.63 | 5.43 | 24.8x | 12.89 | 5.66 | 2.28x |
| bench_loop | 108.34 | 2.19 | 49.5x | 12.93 | 5.81 | 2.23x |
