...
_Generated by `scripts/update_bench.sh` on 2026-05-20T06:10:34Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.66 | 1.68 | 29.0x | 12.84 | 4.35 | 2.95x |
| bench_fib | 143.35 | 5.92 | 24.2x | 12.77 | 4.33 | 2.95x |
| bench_loop | 103.56 | 1.95 | 53.1x | 12.87 | 4.68 | 2.75x |
