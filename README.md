...
_Generated by `scripts/update_bench.sh` on 2026-05-21T13:02:32Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 59.52 | 1.60 | 37.2x | 12.93 | 4.91 | 2.63x |
| bench_fib | 141.74 | 5.72 | 24.8x | 12.90 | 4.97 | 2.60x |
| bench_loop | 135.53 | 1.91 | 71.0x | 12.94 | 4.85 | 2.67x |
