...
_Generated by `scripts/update_bench.sh` on 2026-05-21T09:54:35Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.90 | 1.54 | 31.1x | 12.88 | 4.88 | 2.64x |
| bench_fib | 137.88 | 5.43 | 25.4x | 12.89 | 4.76 | 2.71x |
| bench_loop | 109.88 | 1.79 | 61.4x | 12.68 | 4.91 | 2.58x |
