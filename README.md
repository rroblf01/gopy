...
_Generated by `scripts/update_bench.sh` on 2026-05-20T07:07:37Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.46 | 1.50 | 30.3x | 12.89 | 4.60 | 2.80x |
| bench_fib | 133.74 | 5.52 | 24.2x | 12.90 | 4.61 | 2.80x |
| bench_loop | 105.47 | 1.75 | 60.3x | 12.87 | 4.56 | 2.82x |
