...
_Generated by `scripts/update_bench.sh` on 2026-05-20T04:57:58Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 52.68 | 1.93 | 27.3x | 12.64 | 4.25 | 2.97x |
| bench_fib | 142.53 | 6.49 | 22.0x | 12.72 | 4.26 | 2.99x |
| bench_loop | 116.51 | 2.15 | 54.2x | 12.62 | 4.38 | 2.88x |
...
- [x] `pathlib.Path` arithmetic (`p / "sub"`), `.name`, `.parent`
- [ ] `pathlib.Path` iteration (`p.iterdir()`) and globbing
