...
_Generated by `scripts/update_bench.sh` on 2026-05-21T09:24:48Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.01 | 1.50 | 30.7x | 12.91 | 4.88 | 2.65x |
| bench_fib | 133.26 | 5.39 | 24.7x | 12.76 | 5.02 | 2.54x |
| bench_loop | 105.67 | 1.79 | 59.0x | 12.87 | 4.97 | 2.59x |
