...
_Generated by `scripts/update_bench.sh` on 2026-05-21T12:59:14Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.73 | 2.08 | 22.9x | 12.81 | 4.96 | 2.58x |
| bench_fib | 142.55 | 6.04 | 23.6x | 12.83 | 4.84 | 2.65x |
| bench_loop | 108.43 | 2.17 | 50.0x | 12.85 | 4.84 | 2.65x |
