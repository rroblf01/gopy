...
_Generated by `scripts/update_bench.sh` on 2026-05-20T10:14:27Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.12 | 1.58 | 30.5x | 12.81 | 4.68 | 2.74x |
| bench_fib | 136.53 | 5.46 | 25.0x | 12.79 | 4.68 | 2.73x |
| bench_loop | 106.62 | 1.85 | 57.6x | 12.90 | 4.56 | 2.83x |
