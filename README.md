...
_Generated by `scripts/update_bench.sh` on 2026-05-21T06:12:40Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.46 | 1.49 | 31.2x | 12.86 | 4.82 | 2.67x |
| bench_fib | 137.17 | 5.46 | 25.1x | 12.82 | 4.71 | 2.72x |
| bench_loop | 107.04 | 1.83 | 58.5x | 12.93 | 4.71 | 2.75x |
