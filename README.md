...
_Generated by `scripts/update_bench.sh` on 2026-05-18T06:42:01Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.48 | 2.09 | 22.2x | 12.96 | 4.35 | 2.98x |
| bench_fib | 133.90 | 5.53 | 24.2x | 12.95 | 4.36 | 2.97x |
| bench_loop | 107.94 | 1.79 | 60.3x | 12.83 | 4.36 | 2.94x |
...
- [x] `urllib.parse.quote` / `unquote` (no `urlencode` yet)
