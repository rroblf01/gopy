...
_Generated by `scripts/update_bench.sh` on 2026-05-21T06:47:40Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.15 | 1.86 | 25.3x | 12.79 | 4.59 | 2.79x |
| bench_fib | 133.29 | 5.35 | 24.9x | 12.89 | 4.60 | 2.80x |
| bench_loop | 107.75 | 1.83 | 58.9x | 12.79 | 4.35 | 2.94x |
