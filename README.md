...
_Generated by `scripts/update_bench.sh` on 2026-05-22T11:17:25Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.95 | 1.56 | 30.1x | 12.90 | 6.00 | 2.15x |
| bench_fib | 134.13 | 5.41 | 24.8x | 12.87 | 5.66 | 2.27x |
| bench_loop | 105.97 | 1.79 | 59.2x | 12.88 | 5.84 | 2.21x |
