...
_Generated by `scripts/update_bench.sh` on 2026-05-20T11:27:00Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.99 | 1.49 | 31.5x | 12.84 | 4.63 | 2.77x |
| bench_fib | 138.26 | 5.40 | 25.6x | 12.81 | 4.64 | 2.76x |
| bench_loop | 105.95 | 1.92 | 55.2x | 12.78 | 4.39 | 2.91x |
