...
_Generated by `scripts/update_bench.sh` on 2026-05-21T07:08:35Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.98 | 1.59 | 30.2x | 12.77 | 4.86 | 2.63x |
| bench_fib | 134.34 | 5.66 | 23.7x | 12.81 | 4.43 | 2.89x |
| bench_loop | 106.93 | 1.80 | 59.4x | 12.88 | 4.43 | 2.91x |
