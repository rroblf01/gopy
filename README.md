...
_Generated by `scripts/update_bench.sh` on 2026-05-21T10:26:37Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.11 | 1.59 | 29.6x | 12.88 | 4.95 | 2.60x |
| bench_fib | 133.17 | 5.57 | 23.9x | 12.90 | 4.66 | 2.77x |
| bench_loop | 110.24 | 1.98 | 55.7x | 12.77 | 4.81 | 2.65x |
