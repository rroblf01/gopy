...
_Generated by `scripts/update_bench.sh` on 2026-05-22T13:52:58Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.96 | 1.72 | 28.5x | 12.84 | 5.89 | 2.18x |
| bench_fib | 136.15 | 5.48 | 24.8x | 12.91 | 5.75 | 2.25x |
| bench_loop | 107.54 | 2.01 | 53.5x | 12.85 | 5.78 | 2.22x |
