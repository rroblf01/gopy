...
_Generated by `scripts/update_bench.sh` on 2026-05-20T04:25:30Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 54.52 | 1.68 | 32.5x | 12.75 | 4.49 | 2.84x |
| bench_fib | 141.67 | 6.04 | 23.5x | 12.70 | 4.37 | 2.91x |
| bench_loop | 109.99 | 2.05 | 53.7x | 12.76 | 4.37 | 2.92x |
...
- [x] `os.getcwd()`, `os.listdir(p)`, `os.makedirs(p[, exist_ok])`, `os.path.join`, `os.path.exists`, `os.path.isfile`, `os.path.isdir`, `os.path.basename`, `os.path.dirname`, `os.path.splitext`, `os.path.abspath`
