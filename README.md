...
_Generated by `scripts/update_bench.sh` on 2026-05-21T12:36:07Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.78 | 1.85 | 24.7x | 12.88 | 4.95 | 2.60x |
| bench_fib | 135.02 | 5.30 | 25.5x | 12.87 | 5.08 | 2.53x |
| bench_loop | 106.06 | 1.72 | 61.7x | 12.90 | 4.83 | 2.67x |
