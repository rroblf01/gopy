...
_Generated by `scripts/update_bench.sh` on 2026-05-21T07:22:51Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.03 | 1.51 | 30.5x | 12.89 | 4.78 | 2.70x |
| bench_fib | 132.78 | 5.30 | 25.1x | 12.85 | 4.48 | 2.87x |
| bench_loop | 107.50 | 1.86 | 57.8x | 12.88 | 4.86 | 2.65x |
