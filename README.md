...
_Generated by `scripts/update_bench.sh` on 2026-05-20T09:46:21Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.40 | 1.57 | 29.6x | 12.87 | 4.58 | 2.81x |
| bench_fib | 132.11 | 5.33 | 24.8x | 12.91 | 4.36 | 2.96x |
| bench_loop | 104.68 | 1.76 | 59.5x | 12.88 | 4.74 | 2.72x |
