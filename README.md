...
_Generated by `scripts/update_bench.sh` on 2026-05-22T11:32:44Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.61 | 1.65 | 28.2x | 12.85 | 6.05 | 2.12x |
| bench_fib | 135.75 | 5.53 | 24.5x | 12.92 | 5.86 | 2.20x |
| bench_loop | 109.81 | 3.43 | 32.0x | 12.86 | 5.45 | 2.36x |
