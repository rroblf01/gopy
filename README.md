...
_Generated by `scripts/update_bench.sh` on 2026-05-22T06:07:42Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.56 | 1.50 | 31.0x | 12.82 | 5.33 | 2.41x |
| bench_fib | 135.89 | 5.41 | 25.1x | 12.87 | 5.23 | 2.46x |
| bench_loop | 108.20 | 1.77 | 61.1x | 12.77 | 5.08 | 2.51x |
