...
_Generated by `scripts/update_bench.sh` on 2026-05-20T09:05:14Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.06 | 1.57 | 30.0x | 12.88 | 4.55 | 2.83x |
| bench_fib | 134.73 | 5.47 | 24.6x | 12.79 | 4.56 | 2.80x |
| bench_loop | 108.80 | 1.87 | 58.2x | 12.89 | 4.51 | 2.86x |
