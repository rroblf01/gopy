...
_Generated by `scripts/update_bench.sh` on 2026-05-18T07:02:39Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.60 | 1.57 | 29.7x | 12.76 | 4.58 | 2.79x |
| bench_fib | 134.96 | 5.44 | 24.8x | 12.85 | 4.46 | 2.88x |
| bench_loop | 106.80 | 1.85 | 57.7x | 12.83 | 4.46 | 2.88x |
