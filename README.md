...
_Generated by `scripts/update_bench.sh` on 2026-05-20T11:49:20Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 49.51 | 1.73 | 28.6x | 12.84 | 4.45 | 2.89x |
| bench_fib | 135.83 | 5.73 | 23.7x | 12.84 | 4.59 | 2.80x |
| bench_loop | 110.42 | 1.85 | 59.7x | 12.86 | 4.47 | 2.88x |
...
- [x] `datetime.datetime.fromtimestamp(ts)`, `.fromisoformat(s)`, `.utcnow()`, `.weekday()`, `.isoweekday()`, `.timestamp()`, `datetime.combine(date, time)`
