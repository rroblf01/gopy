...
_Generated by `scripts/update_bench.sh` on 2026-05-21T10:04:03Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.96 | 1.52 | 30.9x | 12.86 | 4.86 | 2.65x |
| bench_fib | 132.80 | 5.33 | 24.9x | 12.91 | 4.80 | 2.69x |
| bench_loop | 105.54 | 1.75 | 60.3x | 12.83 | 4.88 | 2.63x |
