...
_Generated by `scripts/update_bench.sh` on 2026-05-21T08:45:28Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.08 | 1.56 | 30.8x | 12.89 | 4.82 | 2.67x |
| bench_fib | 132.55 | 5.30 | 25.0x | 12.90 | 4.59 | 2.81x |
| bench_loop | 108.35 | 1.73 | 62.6x | 12.85 | 4.82 | 2.67x |
