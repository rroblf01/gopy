...
_Generated by `scripts/update_bench.sh` on 2026-05-18T11:26:27Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.49 | 1.56 | 29.8x | 12.89 | 4.36 | 2.96x |
| bench_fib | 134.60 | 5.51 | 24.4x | 12.88 | 4.32 | 2.98x |
| bench_loop | 107.29 | 1.70 | 63.1x | 12.87 | 4.70 | 2.74x |
