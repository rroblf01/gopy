...
- Builtins: `print`, `len`, `str`, `int`, `float`, `range`, `sorted`, `sum`, `min`, `max`, `any`, `all`, `reversed`, `abs`, `round`, `isinstance`, `pow`, `chr`, `ord`, `repr`, `divmod`, `getattr`, `setattr`, `hasattr`
...
_Generated by `scripts/update_bench.sh` on 2026-05-18T07:11:53Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.52 | 1.57 | 29.6x | 12.90 | 4.35 | 2.97x |
| bench_fib | 134.29 | 5.39 | 24.9x | 12.82 | 4.43 | 2.89x |
| bench_loop | 106.98 | 1.91 | 56.0x | 12.86 | 4.36 | 2.95x |
