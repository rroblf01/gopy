...
_Generated by `scripts/update_bench.sh` on 2026-05-20T06:35:55Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.79 | 1.50 | 32.5x | 12.91 | 4.67 | 2.76x |
| bench_fib | 138.66 | 6.47 | 21.4x | 12.91 | 4.81 | 2.68x |
| bench_loop | 110.06 | 1.87 | 58.9x | 12.80 | 4.69 | 2.73x |
...
- [x] `pathlib.Path.iterdir()` (returns `[]*Path`), `.mkdir(parents, exist_ok)`, `.unlink()`
