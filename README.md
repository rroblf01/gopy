...
_Generated by `scripts/update_bench.sh` on 2026-05-20T08:58:31Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.55 | 1.50 | 30.4x | 12.91 | 4.72 | 2.74x |
| bench_fib | 134.21 | 5.77 | 23.3x | 12.93 | 4.48 | 2.89x |
| bench_loop | 108.69 | 2.02 | 53.8x | 12.85 | 4.50 | 2.86x |
