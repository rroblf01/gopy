...
_Generated by `scripts/update_bench.sh` on 2026-05-18T07:56:25Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.91 | 1.49 | 32.2x | 12.80 | 4.46 | 2.87x |
| bench_fib | 133.84 | 5.31 | 25.2x | 12.89 | 4.38 | 2.94x |
| bench_loop | 106.91 | 1.82 | 58.7x | 12.93 | 4.55 | 2.84x |
