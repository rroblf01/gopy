...
_Generated by `scripts/update_bench.sh` on 2026-05-21T09:44:21Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.09 | 1.54 | 31.2x | 12.92 | 4.96 | 2.60x |
| bench_fib | 135.72 | 5.62 | 24.1x | 12.73 | 4.71 | 2.70x |
| bench_loop | 109.61 | 1.74 | 63.0x | 12.90 | 4.46 | 2.89x |
