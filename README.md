...
_Generated by `scripts/update_bench.sh` on 2026-05-21T06:42:36Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.49 | 1.53 | 30.4x | 12.94 | 4.96 | 2.61x |
| bench_fib | 134.31 | 5.63 | 23.9x | 12.84 | 4.65 | 2.76x |
| bench_loop | 108.84 | 1.77 | 61.5x | 12.88 | 4.60 | 2.80x |
