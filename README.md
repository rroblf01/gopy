...
_Generated by `scripts/update_bench.sh` on 2026-05-22T07:25:44Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.89 | 1.58 | 30.9x | 12.94 | 5.16 | 2.51x |
| bench_fib | 134.56 | 5.70 | 23.6x | 12.86 | 5.04 | 2.55x |
| bench_loop | 106.93 | 1.97 | 54.3x | 12.71 | 5.17 | 2.46x |
