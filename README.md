...
_Generated by `scripts/update_bench.sh` on 2026-05-20T11:05:18Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 53.90 | 2.14 | 25.2x | 12.73 | 4.75 | 2.68x |
| bench_fib | 141.39 | 6.10 | 23.2x | 12.69 | 4.61 | 2.75x |
| bench_loop | 121.10 | 2.45 | 49.4x | 12.79 | 4.63 | 2.76x |
...
- [x] `dataclasses.asdict(obj)` (returns `map[string]any`), `dataclasses.astuple(obj)` (returns `[]any`), `dataclasses.replace(obj, **kwargs)` (fresh instance via constructor)
