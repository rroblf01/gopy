...
_Generated by `scripts/update_bench.sh` on 2026-05-22T06:35:20Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.98 | 1.83 | 26.2x | 12.84 | 5.40 | 2.38x |
| bench_fib | 134.31 | 5.46 | 24.6x | 12.84 | 5.07 | 2.53x |
| bench_loop | 109.25 | 1.97 | 55.5x | 12.81 | 5.07 | 2.53x |
