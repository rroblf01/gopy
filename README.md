...
_Generated by `scripts/update_bench.sh` on 2026-05-20T09:53:37Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.47 | 1.58 | 30.7x | 12.93 | 4.81 | 2.69x |
| bench_fib | 135.13 | 5.56 | 24.3x | 12.85 | 4.49 | 2.86x |
| bench_loop | 107.68 | 1.85 | 58.2x | 12.80 | 4.34 | 2.95x |
