...
_Generated by `scripts/update_bench.sh` on 2026-05-18T08:06:16Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.84 | 1.45 | 31.6x | 12.86 | 4.20 | 3.06x |
| bench_fib | 131.94 | 5.38 | 24.5x | 12.90 | 4.55 | 2.84x |
| bench_loop | 104.97 | 1.76 | 59.6x | 12.84 | 4.53 | 2.83x |
