...
_Generated by `scripts/update_bench.sh` on 2026-05-22T10:59:41Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.99 | 1.53 | 30.7x | 12.92 | 5.98 | 2.16x |
| bench_fib | 139.01 | 5.51 | 25.2x | 12.86 | 5.64 | 2.28x |
| bench_loop | 107.27 | 1.75 | 61.3x | 12.85 | 5.76 | 2.23x |
