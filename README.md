...
_Generated by `scripts/update_bench.sh` on 2026-05-20T10:02:40Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.76 | 1.72 | 27.8x | 12.73 | 4.72 | 2.70x |
| bench_fib | 134.17 | 5.44 | 24.7x | 12.77 | 4.43 | 2.88x |
| bench_loop | 108.52 | 1.99 | 54.5x | 12.69 | 4.62 | 2.75x |
