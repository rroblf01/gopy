...
_Generated by `scripts/update_bench.sh` on 2026-05-21T11:29:19Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 44.94 | 1.48 | 30.4x | 12.96 | 5.06 | 2.56x |
| bench_fib | 133.53 | 5.34 | 25.0x | 12.95 | 4.95 | 2.62x |
| bench_loop | 105.68 | 1.74 | 60.7x | 12.82 | 4.95 | 2.59x |
