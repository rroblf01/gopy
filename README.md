...
_Generated by `scripts/update_bench.sh` on 2026-05-21T15:35:07Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.53 | 1.52 | 31.3x | 12.90 | 5.25 | 2.46x |
| bench_fib | 137.06 | 5.58 | 24.6x | 12.86 | 4.93 | 2.61x |
| bench_loop | 108.75 | 1.88 | 57.8x | 12.82 | 4.81 | 2.67x |
