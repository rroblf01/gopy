...
_Generated by `scripts/update_bench.sh` on 2026-05-21T15:06:26Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 49.01 | 1.62 | 30.3x | 12.87 | 4.84 | 2.66x |
| bench_fib | 137.27 | 5.33 | 25.8x | 12.85 | 5.29 | 2.43x |
| bench_loop | 108.34 | 1.80 | 60.2x | 12.91 | 4.66 | 2.77x |
