...
- Builtins: `print`, `len`, `str`, `int`, `float`, `range`, `sorted`, `sum`, `min`, `max`, `any`, `all`, `reversed`, `abs`, `round`, `isinstance` (single class or tuple-of-classes), `issubclass`, `pow`, `chr`, `ord`, `repr`, `divmod`, `getattr`, `setattr`, `hasattr`, `list` (iterator materialization — pass-through in the gopy shim)
...
_Generated by `scripts/update_bench.sh` on 2026-05-18T07:28:04Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.43 | 1.51 | 30.1x | 12.85 | 4.33 | 2.97x |
| bench_fib | 132.44 | 5.29 | 25.0x | 12.89 | 4.49 | 2.87x |
| bench_loop | 106.08 | 1.77 | 59.9x | 12.93 | 4.64 | 2.79x |
