...
_Generated by `scripts/update_bench.sh` on 2026-05-20T14:15:47Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.37 | 1.52 | 31.8x | 12.84 | 4.71 | 2.73x |
| bench_fib | 134.80 | 5.47 | 24.6x | 12.94 | 4.80 | 2.70x |
| bench_loop | 106.97 | 1.72 | 62.2x | 12.80 | 4.68 | 2.74x |
