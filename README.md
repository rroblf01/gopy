...
_Generated by `scripts/update_bench.sh` on 2026-05-21T06:26:58Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.97 | 1.45 | 31.7x | 12.86 | 4.83 | 2.66x |
| bench_fib | 131.88 | 5.34 | 24.7x | 12.89 | 4.71 | 2.74x |
| bench_loop | 104.73 | 1.75 | 59.8x | 12.92 | 4.74 | 2.73x |
