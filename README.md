...
_Generated by `scripts/update_bench.sh` on 2026-05-21T06:37:14Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.11 | 1.51 | 30.5x | 12.81 | 4.96 | 2.58x |
| bench_fib | 134.27 | 5.37 | 25.0x | 12.83 | 4.72 | 2.72x |
| bench_loop | 106.82 | 1.79 | 59.7x | 12.89 | 4.59 | 2.81x |
