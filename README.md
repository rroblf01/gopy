...
_Generated by `scripts/update_bench.sh` on 2026-05-21T16:02:14Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.61 | 1.61 | 29.6x | 12.96 | 5.33 | 2.43x |
| bench_fib | 136.23 | 5.43 | 25.1x | 12.88 | 5.16 | 2.50x |
| bench_loop | 107.10 | 1.73 | 61.9x | 12.89 | 4.96 | 2.60x |
