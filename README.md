...
_Generated by `scripts/update_bench.sh` on 2026-05-21T14:18:54Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.13 | 1.47 | 31.4x | 12.93 | 4.97 | 2.60x |
| bench_fib | 132.37 | 5.26 | 25.2x | 12.84 | 4.86 | 2.64x |
| bench_loop | 105.49 | 1.79 | 58.9x | 12.95 | 5.08 | 2.55x |
