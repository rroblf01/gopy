...
_Generated by `scripts/update_bench.sh` on 2026-05-20T11:56:41Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.17 | 1.52 | 31.7x | 12.82 | 4.72 | 2.72x |
| bench_fib | 135.22 | 5.77 | 23.4x | 12.88 | 4.73 | 2.72x |
| bench_loop | 108.74 | 1.94 | 56.1x | 12.86 | 4.61 | 2.79x |
