...
_Generated by `scripts/update_bench.sh` on 2026-05-21T12:10:52Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.24 | 1.75 | 27.6x | 12.87 | 5.07 | 2.54x |
| bench_fib | 136.97 | 5.41 | 25.3x | 12.77 | 4.98 | 2.56x |
| bench_loop | 122.34 | 2.15 | 56.9x | 12.84 | 4.88 | 2.63x |
