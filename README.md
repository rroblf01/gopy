...
_Generated by `scripts/update_bench.sh` on 2026-05-19T13:37:17Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.41 | 1.52 | 30.5x | 12.73 | 4.24 | 3.00x |
| bench_fib | 132.70 | 5.82 | 22.8x | 12.57 | 4.47 | 2.81x |
| bench_loop | 107.55 | 1.80 | 59.8x | 12.72 | 4.57 | 2.78x |
