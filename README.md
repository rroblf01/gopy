...
- Builtins: `print`, `len`, `str`, `int`, `float`, `range`, `sorted`, `sum`, `min`, `max`, `any`, `all`, `reversed`, `abs`, `round`, `isinstance` (single class or tuple-of-classes), `issubclass`, `pow`, `chr`, `ord`, `repr`, `divmod`, `getattr`, `setattr`, `hasattr`
...
_Generated by `scripts/update_bench.sh` on 2026-05-18T07:19:40Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.57 | 1.56 | 29.9x | 12.86 | 4.62 | 2.78x |
| bench_fib | 133.03 | 5.45 | 24.4x | 12.76 | 4.53 | 2.82x |
| bench_loop | 107.40 | 1.81 | 59.3x | 12.86 | 4.68 | 2.75x |
...
- [x] `itertools.chain`, `itertools.accumulate`, `itertools.takewhile`, `itertools.dropwhile`
