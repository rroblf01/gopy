...
_Generated by `scripts/update_bench.sh` on 2026-05-21T15:53:55Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.86 | 1.65 | 29.0x | 12.89 | 5.13 | 2.51x |
| bench_fib | 136.15 | 5.63 | 24.2x | 12.73 | 4.81 | 2.65x |
| bench_loop | 110.16 | 1.88 | 58.6x | 12.82 | 5.26 | 2.44x |
