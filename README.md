...
_Generated by `scripts/update_bench.sh` on 2026-05-20T11:40:23Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.86 | 1.62 | 29.5x | 12.85 | 4.56 | 2.82x |
| bench_fib | 136.09 | 5.84 | 23.3x | 12.84 | 4.59 | 2.80x |
| bench_loop | 113.79 | 2.04 | 55.8x | 12.83 | 4.59 | 2.80x |
