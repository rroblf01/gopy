...
_Generated by `scripts/update_bench.sh` on 2026-05-21T12:53:57Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.91 | 1.59 | 30.1x | 12.87 | 5.02 | 2.56x |
| bench_fib | 136.28 | 5.57 | 24.5x | 12.57 | 4.86 | 2.59x |
| bench_loop | 110.08 | 1.95 | 56.5x | 12.79 | 4.83 | 2.65x |
