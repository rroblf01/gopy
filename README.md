...
_Generated by `scripts/update_bench.sh` on 2026-05-21T10:33:15Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.46 | 1.56 | 30.4x | 12.88 | 4.95 | 2.60x |
| bench_fib | 135.58 | 5.33 | 25.4x | 12.88 | 4.81 | 2.68x |
| bench_loop | 111.05 | 1.77 | 62.7x | 12.85 | 4.93 | 2.61x |
