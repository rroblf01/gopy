...
_Generated by `scripts/update_bench.sh` on 2026-05-21T15:46:50Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.73 | 1.64 | 29.1x | 12.91 | 4.87 | 2.65x |
| bench_fib | 138.33 | 5.90 | 23.4x | 12.70 | 5.06 | 2.51x |
| bench_loop | 108.11 | 1.78 | 60.7x | 12.82 | 4.94 | 2.60x |
