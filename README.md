...
_Generated by `scripts/update_bench.sh` on 2026-05-20T06:27:36Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.52 | 1.49 | 30.6x | 12.95 | 4.62 | 2.80x |
| bench_fib | 137.71 | 5.51 | 25.0x | 12.83 | 4.55 | 2.82x |
| bench_loop | 107.38 | 1.95 | 55.1x | 12.83 | 4.68 | 2.74x |
