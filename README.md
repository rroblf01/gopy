...
_Generated by `scripts/update_bench.sh` on 2026-05-20T14:28:34Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.95 | 1.58 | 29.7x | 12.88 | 4.80 | 2.68x |
| bench_fib | 140.68 | 5.36 | 26.2x | 12.75 | 4.79 | 2.66x |
| bench_loop | 105.28 | 2.08 | 50.6x | 12.86 | 4.62 | 2.78x |
