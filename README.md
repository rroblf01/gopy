...
_Generated by `scripts/update_bench.sh` on 2026-05-22T07:06:19Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.09 | 1.53 | 30.1x | 12.84 | 5.33 | 2.41x |
| bench_fib | 135.12 | 5.52 | 24.5x | 12.85 | 5.34 | 2.41x |
| bench_loop | 107.67 | 1.99 | 54.1x | 12.90 | 5.21 | 2.48x |
