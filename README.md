...
_Generated by `scripts/update_bench.sh` on 2026-05-21T14:40:35Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.86 | 1.55 | 30.2x | 12.83 | 5.07 | 2.53x |
| bench_fib | 133.35 | 5.28 | 25.3x | 12.86 | 5.07 | 2.54x |
| bench_loop | 107.44 | 1.80 | 59.7x | 12.89 | 4.94 | 2.61x |
