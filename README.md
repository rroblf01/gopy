...
_Generated by `scripts/update_bench.sh` on 2026-05-21T15:18:44Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.55 | 1.62 | 30.0x | 12.92 | 5.26 | 2.46x |
| bench_fib | 136.14 | 5.59 | 24.4x | 12.83 | 5.18 | 2.48x |
| bench_loop | 110.89 | 1.96 | 56.6x | 12.76 | 4.78 | 2.67x |
