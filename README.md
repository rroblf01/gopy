...
_Generated by `scripts/update_bench.sh` on 2026-05-20T11:34:47Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 49.91 | 1.74 | 28.7x | 12.83 | 4.51 | 2.84x |
| bench_fib | 133.68 | 5.92 | 22.6x | 12.85 | 4.77 | 2.69x |
| bench_loop | 111.21 | 2.13 | 52.2x | 12.78 | 4.52 | 2.83x |
