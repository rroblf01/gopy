...
_Generated by `scripts/update_bench.sh` on 2026-05-21T14:53:44Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.51 | 1.53 | 31.1x | 12.85 | 5.27 | 2.44x |
| bench_fib | 136.02 | 5.43 | 25.0x | 12.78 | 5.03 | 2.54x |
| bench_loop | 109.25 | 1.72 | 63.5x | 12.84 | 4.67 | 2.75x |
