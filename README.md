...
_Generated by `scripts/update_bench.sh` on 2026-05-19T14:42:10Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 47.12 | 1.52 | 31.0x | 12.74 | 4.52 | 2.82x |
| bench_fib | 133.47 | 5.52 | 24.2x | 12.67 | 4.30 | 2.95x |
| bench_loop | 105.86 | 1.90 | 55.7x | 12.68 | 4.18 | 3.03x |
