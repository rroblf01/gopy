...
_Generated by `scripts/update_bench.sh` on 2026-05-20T09:40:58Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 48.66 | 1.72 | 28.3x | 12.90 | 4.71 | 2.74x |
| bench_fib | 135.40 | 5.41 | 25.0x | 12.84 | 4.77 | 2.69x |
| bench_loop | 110.29 | 1.81 | 60.9x | 12.76 | 4.59 | 2.78x |
...
- [x] `datetime.datetime.fromtimestamp(ts)`, `.fromisoformat(s)`, `.utcnow()`
