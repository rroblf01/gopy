...
_Generated by `scripts/update_bench.sh` on 2026-05-21T07:37:08Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 54.28 | 1.78 | 30.5x | 12.84 | 4.99 | 2.57x |
| bench_fib | 156.94 | 5.72 | 27.4x | 12.81 | 4.75 | 2.70x |
| bench_loop | 125.90 | 1.87 | 67.3x | 12.77 | 4.75 | 2.69x |
