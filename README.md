...
_Generated by `scripts/update_bench.sh` on 2026-05-18T07:33:38Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.43 | 1.47 | 31.6x | 12.93 | 4.46 | 2.90x |
| bench_fib | 132.54 | 5.34 | 24.8x | 12.84 | 4.47 | 2.87x |
| bench_loop | 105.45 | 1.79 | 58.9x | 12.87 | 4.60 | 2.80x |
