...
_Generated by `scripts/update_bench.sh` on 2026-05-21T13:06:16Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 45.89 | 1.49 | 30.8x | 12.85 | 5.09 | 2.52x |
| bench_fib | 132.51 | 5.41 | 24.5x | 12.95 | 4.97 | 2.61x |
| bench_loop | 106.19 | 1.72 | 61.7x | 12.88 | 5.05 | 2.55x |
