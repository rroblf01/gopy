...
_Generated by `scripts/update_bench.sh` on 2026-05-21T09:50:24Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 50.16 | 1.63 | 30.8x | 12.91 | 4.86 | 2.66x |
| bench_fib | 136.44 | 6.44 | 21.2x | 12.85 | 4.77 | 2.69x |
| bench_loop | 106.71 | 1.94 | 55.0x | 12.86 | 4.72 | 2.72x |
