...
_Generated by `scripts/update_bench.sh` on 2026-05-21T07:14:16Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.39 | 1.47 | 31.6x | 12.87 | 5.05 | 2.55x |
| bench_fib | 132.76 | 5.43 | 24.4x | 12.96 | 4.55 | 2.85x |
| bench_loop | 105.78 | 1.78 | 59.4x | 12.83 | 4.80 | 2.67x |
