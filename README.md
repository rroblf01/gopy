...
_Generated by `scripts/update_bench.sh` on 2026-05-18T06:51:33Z._

| Benchmark | CPython (ms) | gopy Go (ms) | Speedup | Python RSS (MB) | gopy RSS (MB) | RSS save |
|-----------|-------------:|-------------:|--------:|----------------:|--------------:|---------:|
| bench_class | 46.34 | 1.51 | 30.7x | 12.86 | 3.92 | 3.28x |
| bench_fib | 133.37 | 5.54 | 24.1x | 12.94 | 4.25 | 3.04x |
| bench_loop | 106.87 | 1.77 | 60.4x | 12.81 | 4.30 | 2.98x |
